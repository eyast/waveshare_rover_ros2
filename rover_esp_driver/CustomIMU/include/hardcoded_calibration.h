...
#define HARDCODED_MAG_OFFSET_X  26.27f
#define HARDCODED_MAG_OFFSET_Y -54.80f
#define HARDCODED_MAG_OFFSET_Z -27.07f

// Soft iron matrix - compensates for magnetic field distortion
// This is a symmetric 3x3 matrix
#define HARDCODED_SOFT_IRON_00  1.038f
#define HARDCODED_SOFT_IRON_01  0.018f
#define HARDCODED_SOFT_IRON_02 -0.065f
#define HARDCODED_SOFT_IRON_10  0.018f  // Same as 01 (symmetric)
#define HARDCODED_SOFT_IRON_11  1.057f
#define HARDCODED_SOFT_IRON_12  0.002f
#define HARDCODED_SOFT_IRON_20 -0.065f  // Same as 02 (symmetric)
#define HARDCODED_SOFT_IRON_21  0.002f  // Same as 12 (symmetric)
#define HARDCODED_SOFT_IRON_22  0.916f

// Expected magnetic field strength (uT)
#define HARDCODED_FIELD_STRENGTH 55.14f
